...
* Improves scalability for any Middleware and API-driven workloads with concurrent users.
...
=== Support Resources
* For more information on the Atina JDE Microservices - User Guide, visit its link:link:1.0.0/functional/jde.html[User Guide].
