...
Remove all parameters that start with `_BSFN` as they are not required in Atina. The Atina connector handles exceptions and transactions differently, so you can omit these parameters when migrating.
