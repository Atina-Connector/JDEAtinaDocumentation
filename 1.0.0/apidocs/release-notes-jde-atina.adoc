...
== Atina JDE Edwards Microservice 1.0.4 - April 9, 2026
...
==== 2. Submit UBE XML Request - Error Handling and Cache Validation
...
```env
UBE_SUBMISSION_USER_CONTEXT=logged_in_user
```
